    ...
    <div class="product-details">
      ...
      if (isset($_GET['id'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          echo "<form method='post' action='add_to_cart.php'>"; // Form for submitting to add_to_cart.php
          echo "<input type='hidden' name='product_id' value='" . $row['id'] . "'>"; // Hidden field for product ID
          echo "<button type='submit' class='add-bag-btn'>Add To Cart</button>";
          echo "</form>";
          echo "<a href='id=" . $row['id'] . "' class='add-wishlist-btn'>Purches Now</a>"; // Pass product ID as a parameter
          echo "</div>";
